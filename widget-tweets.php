...
{
	add_options_page(
		__('Twitter Settings', 'bean'), __('Bean Tweets', 'bean'), 'manage_options', 'bean-tweets-plugin-settings', 'bean_tweets_settings_render_admin_page'
	);
...
/*===================================================================*/  
function bean_tweets_settings_render_admin_page() 
{
	...
	echo '<div class="wrap">';
		...
		echo '</div>';
	echo '</div>';
} //END bean_tweets_settings_render_admin_page
?>